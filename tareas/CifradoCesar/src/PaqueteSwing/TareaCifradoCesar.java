...
String  alfabeto = "abcdefghijklmnñopqrstuvwxyz";
   ...
   public TareaCifradoCesar() throws HeadlessException {
       ...
       cuadroDesplazamiento = new JTextField(2);
       cuadroMensaje = new JTextField(15);
       boton = new JButton();
       ...
       this.addWindowListener(new WindowAdapter() {
        ...
        JOptionPane.showMessageDialog(null, "Formato incorrecto, intentelo de nuevo", "Error de captura", JOptionPane.ERROR_MESSAGE);
        }
    }
       });
